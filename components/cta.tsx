          ...
          <div className="max-w-3xl mx-auto text-center">
            <div>
              <div className="inline-flex font-medium bg-clip-text text-transparent bg-gradient-to-r from-purple-500 to-purple-200 pb-3">
                Genrative AI Tracking and Observability
              </div>
            </div>
            ...
            <p className="text-lg text-slate-400 mb-8">
              Unlock the full potential of your brand with TrackGenAI. Our
              platform uses advanced AI tools like ChatGPT, Claude, and Gemini
              to provide real-time insights and comprehensive analysis of your
              keywords and prompts. Stay ahead of market trends, enhance your
              marketing strategies, and drive growth with actionable data. Start
              optimizing your business today.
            </p>
            <div>
              <a
