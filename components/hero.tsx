        ...
        <div className="pt-32 pb-16 md:pt-52 md:pb-32">
          ...
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p
              ...
              data-aos-delay="200"
            >
              Monitor your brand's keywords in real-time across major AI
              platforms like ChatGPT, Claude, Gemini AI, and more. Get instant
              updates on how your brand is being discussed.
            </p>
            <div
